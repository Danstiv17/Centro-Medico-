...
import jpa.entitis.Pacientes;
import jsf.util.JsfUtil;
import jsf.util.PaginationHelper;
import jpa.cesions.PacientesFacade;
...
public class PacientesController implements Serializable {
    ...
    @EJB
    private jpa.cesions.PacientesFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("PacientesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("PacientesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourses/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("PacientesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourses/Bundle").getString("PersistenceErrorOccured"));
        }
    }
