...
import jpa.entitis.Citas;
import jsf.util.JsfUtil;
import jsf.util.PaginationHelper;
import jpa.cesions.CitasFacade;
...
public class CitasController implements Serializable {
    ...
    @EJB
    private jpa.cesions.CitasFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("CitasCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("CitasUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourses/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourses/Bundle").getString("CitasDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourses/Bundle").getString("PersistenceErrorOccured"));
        }
    }
